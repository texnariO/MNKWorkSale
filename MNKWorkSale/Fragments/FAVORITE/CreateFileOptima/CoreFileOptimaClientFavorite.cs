...
namespace MNKWorkSale.Fragments.FAVORITE.CreateFileOptima
{
    internal class CoreFileOptimaClientFavorite
    {
        ...
        public string CreateFileOptimaClientFavorite(string priceText, string positionText, string countsText, string FileName)
        {
            ...
            using (StreamWriter sw = new StreamWriter(startupPath + "/Wynik/FAVORITE/dwcOp.csv"))
            {
